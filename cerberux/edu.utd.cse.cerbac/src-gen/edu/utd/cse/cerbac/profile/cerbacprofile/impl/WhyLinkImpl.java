 ...
 * </p>
 * <ul>
 *   <li>{@link edu.utd.cse.cerbac.profile.cerbacprofile.impl.WhyLinkImpl#getBase_Association <em>Base Association</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WhyLinkImpl extends MinimalEObjectImpl.Container implements WhyLink {
	...
	protected EClass eStaticClass() {
		return CerbacProfilePackage.Literals.WHY_LINK;
	}
		...
		if (base_Association != null && base_Association.eIsProxy()) {
			...
			if (base_Association != oldBase_Association) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CerbacProfilePackage.WHY_LINK__BASE_ASSOCIATION, oldBase_Association, base_Association));
			}
		}
	...
	public void setBase_Association(Association newBase_Association) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CerbacProfilePackage.WHY_LINK__BASE_ASSOCIATION, oldBase_Association, base_Association));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CerbacProfilePackage.WHY_LINK__BASE_ASSOCIATION:
