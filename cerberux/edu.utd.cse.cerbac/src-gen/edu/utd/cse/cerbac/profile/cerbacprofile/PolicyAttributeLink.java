 ...
 * </p>
 * <ul>
 *   <li>{@link edu.utd.cse.cerbac.profile.cerbacprofile.PolicyAttributeLink#getBase_Association <em>Base Association</em>}</li>
 * </ul>
 *
 * @see edu.utd.cse.cerbac.profile.cerbacprofile.CerbacProfilePackage#getPolicyAttributeLink()
 * @model
 * @generated
 */
public interface PolicyAttributeLink extends EObject {
	 ...
	 * @see edu.utd.cse.cerbac.profile.cerbacprofile.CerbacProfilePackage#getPolicyAttributeLink_Base_Association()
	...
	/**
	 * Sets the value of the '{@link edu.utd.cse.cerbac.profile.cerbacprofile.PolicyAttributeLink#getBase_Association <em>Base Association</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
