 ...
 * </p>
 * <ul>
 *   <li>{@link edu.utd.cse.cerbac.profile.cerbacprofile.ActionLink#getBase_Association <em>Base Association</em>}</li>
 * </ul>
 *
 * @see edu.utd.cse.cerbac.profile.cerbacprofile.CerbacProfilePackage#getActionLink()
 * @model
 * @generated
 */
public interface ActionLink extends EObject {
	 ...
	 * @see edu.utd.cse.cerbac.profile.cerbacprofile.CerbacProfilePackage#getActionLink_Base_Association()
	...
	/**
	 * Sets the value of the '{@link edu.utd.cse.cerbac.profile.cerbacprofile.ActionLink#getBase_Association <em>Base Association</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
