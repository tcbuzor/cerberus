 ...
 * </p>
 * <ul>
 *   <li>{@link edu.utd.cse.cerbac.profile.cerbacprofile.impl.PolicyAttributeLinkImpl#getBase_Association <em>Base Association</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PolicyAttributeLinkImpl extends MinimalEObjectImpl.Container implements PolicyAttributeLink {
	...
	protected EClass eStaticClass() {
		return CerbacProfilePackage.Literals.POLICY_ATTRIBUTE_LINK;
	}
		...
		if (base_Association != null && base_Association.eIsProxy()) {
			...
			if (base_Association != oldBase_Association) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CerbacProfilePackage.POLICY_ATTRIBUTE_LINK__BASE_ASSOCIATION, oldBase_Association, base_Association));
			}
		}
	...
	public void setBase_Association(Association newBase_Association) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CerbacProfilePackage.POLICY_ATTRIBUTE_LINK__BASE_ASSOCIATION, oldBase_Association, base_Association));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CerbacProfilePackage.POLICY_ATTRIBUTE_LINK__BASE_ASSOCIATION:
